...
This document explains how the Orthocal.info API integration works in the Prologue from Ohrid website.
...
1. **Prologue from Ohrid** entry (saints, hymns, reflection, homily)
